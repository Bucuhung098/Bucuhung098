...
if workspace.FilteringEnabled == false then
	if workspace:PGSIsEnabled() then
		notify('Press Z to equip. Craked 2 is stupid by cv_ivc',true)
	else
		notify(' Press Z to knife by leak.',true)
	end
else
	notify('Becomea this game has filtering enabled so it literally wont work here')
end
